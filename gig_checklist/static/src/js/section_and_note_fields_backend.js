...
odoo.define('gig_checklist.section_and_note_backend', function (require) {
...
fieldRegistry.add('gig_section_and_note_one2many', SectionAndNoteFieldOne2Many);
fieldRegistry.add('gig_section_and_note_text', SectionAndNoteFieldText);
